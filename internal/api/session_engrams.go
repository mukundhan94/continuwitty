...
func queryEngramValidationRules(payload models.EngramQueryRequest) []queryEngramValidationRule {
	return []queryEngramValidationRule{
		...
		{detail: "invalid distance_min", invalid: invalidDistanceMin(payload.DistanceMin)},
		{detail: "invalid distance_max", invalid: invalidDistanceMax(payload.DistanceMax)},
		...
		},
		{
			...
			invalid: invalidContradictionRatioMin(payload.ContradictionRatioMin),
		},
		{
		...
		},
		{
			...
			invalid: invalidAvgRelevanceFeedbackMax(payload.AvgRelevanceFeedbackMax),
		},
		{
		...
		{detail: "invalid dense_score_min", invalid: invalidDenseScoreMin(payload.DenseScoreMin)},
		{detail: "invalid dense_score_max", invalid: invalidDenseScoreMax(payload.DenseScoreMax)},
		{
			detail:  "invalid lexical_overlap_score_min",
			invalid: invalidLexicalOverlapScoreMin(payload.LexicalOverlapScoreMin),
		},
		{
			detail:  "invalid lexical_overlap_score_max",
		...
		{
			detail:  "invalid engagement_signal_score_min",
			invalid: invalidEngagementSignalScoreMin(payload.EngagementSignalScoreMin),
		},
		{
			detail:  "invalid engagement_signal_score_max",
			invalid: invalidEngagementSignalScoreMax(payload.EngagementSignalScoreMax),
		},
		{
			detail:  "invalid freshness_signal_score_min",
			invalid: invalidFreshnessSignalScoreMin(payload.FreshnessSignalScoreMin),
		},
		{
			detail:  "invalid freshness_signal_score_max",
...
func invalidUsefulCountMax(value *int) bool {
	return value != nil && *value < 0
}
...
func invalidDistanceMax(value *float64) bool {
	return value != nil && *value < 0
}

func invalidDistanceMin(value *float64) bool {
	return value != nil && *value < 0
}

func invalidFeedbackCountMax(value *int) bool {
	return value != nil && *value < 0
}
...
func invalidContradictionRatioMin(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}
...
func invalidAvgRelevanceFeedbackMax(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}
...
func invalidDenseScoreMin(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}

func invalidDenseScoreMax(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}

func invalidLexicalOverlapScoreMin(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}
...
func invalidEngagementSignalScoreMin(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}

func invalidEngagementSignalScoreMax(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}

func invalidFreshnessSignalScoreMin(value *float64) bool {
	return invalidBoundedUnitInterval(value)
}
...
func invalidQueryNumericWindowDetail(payload models.EngramQueryRequest) string {
	...
	if hasInvalidScoreWindow(payload.DistanceMin, payload.DistanceMax) {
		return "invalid distance window"
	}
	...
	if hasInvalidScoreWindow(payload.DenseScoreMin, payload.DenseScoreMax) {
		return "invalid dense_score window"
	}
	...
	if hasInvalidScoreWindow(payload.EngagementSignalScoreMin, payload.EngagementSignalScoreMax) {
		return "invalid engagement_signal_score window"
	}
