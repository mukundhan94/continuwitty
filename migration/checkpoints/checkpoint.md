...
- **Technical debt follow-up completed (2026-03-01):** cross-provider engram reuse validation now has explicit chat fallback regression coverage asserting identical engram-context reuse and provenance metadata across provider/model switches.
