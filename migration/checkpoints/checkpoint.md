...
- **Phase 37 in progress:** freshness maintenance baseline plus consolidation schema/repository/admin-API baseline shipped (refresh/list routines + tests); consolidation MCP parity, action workflows, and acceptance/benchmark coverage remain.
...
- [ ] Add MCP consolidation tooling parity, action workflows, and acceptance/benchmark coverage.
