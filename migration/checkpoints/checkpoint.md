...
- **Phase 37 in progress:** freshness maintenance baseline plus consolidation schema/repository/admin-API/MCP parity baseline shipped (refresh/list routines + tests); consolidation action workflows and acceptance/benchmark coverage remain.
...
- [ ] Add consolidation action workflows and acceptance/benchmark coverage.
