...
- **Go migration current checkpoint (2026-02-27):** CP173 completed in `checkpoint-go-migration.md` with docs cutover baseline (`README.md` and `docs/user-workflows.md` updated for Go-first runtime/dev flows with explicit legacy Python notes), full `go test ./...` pass, and CodeScene safeguard pass.
