...
- **Go migration current checkpoint (2026-02-27):** CP151 completed in `checkpoint-go-migration.md` with MCP stream-route token policy parity tests (`tools/list` allowlist filtering + read-scope write denial), full `go test ./...` pass, and CodeScene safeguard pass.
