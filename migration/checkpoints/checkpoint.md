...
- **Phase 37 in progress:** freshness maintenance baseline plus consolidation schema/repository/admin-API/MCP parity shipped (refresh/list/action API + MCP tools + tests); acceptance/benchmark coverage remains.
...
- [ ] Add acceptance/benchmark coverage for grouping criteria.
