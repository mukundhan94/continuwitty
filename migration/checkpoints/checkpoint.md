...
- **Phase 40 in progress:** autonomous memory suggestion baseline started with schema/model/repository foundations for `memory_curation_suggestions` (`create/list/action` persistence + tests) ready for API/MCP wiring.
...
- [ ] Add API + MCP routes/tools for memory curation suggestion workflows.
