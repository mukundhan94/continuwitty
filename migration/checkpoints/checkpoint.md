...
- **Phase 37 in progress:** freshness maintenance baseline and consolidation suggestion schema/repository baseline shipped (refresh/list routines + tests); consolidation MCP/API tooling and acceptance/benchmark coverage remain.
