...
- **Go migration current checkpoint (2026-02-27):** CP182 completed in `checkpoint-go-migration.md` with runbook alignment updates (`README.md` + `docs/user-workflows.md`) for migration-complete status and parity workflow commands (`openapi-check`, `shadow-compare`, `benchmark-compare`), full `go test ./...` pass, and CodeScene safeguard pass.
