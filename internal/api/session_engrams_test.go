...
func assertTemporalQueryRequest(t *testing.T, request models.EngramQueryRequest) {
	...
	requireEqual(
		t,
		1,
		requireIntPointer(t, request.ContradictionCountMin, "contradiction_count_min"),
	)
	requireEqual(
		t,
		3,
	...
	requireEqual(
		t,
		0.9,
		requireFloat64Pointer(t, request.AvgRelevanceFeedbackMax, "avg_relevance_feedback_max"),
	)
	requireEqual(
		t,
		0.7,
	...
	requireEqual(
		t,
		0.55,
		requireFloat64Pointer(t, request.FeedbackSignalScoreMin, "feedback_signal_score_min"),
	)
	requireEqual(
		t,
		0.94,
		requireFloat64Pointer(t, request.FeedbackSignalScoreMax, "feedback_signal_score_max"),
	)
	requireEqual(
		t,
		0.45,
		requireFloat64Pointer(t, request.EngagementSignalScoreMin, "engagement_signal_score_min"),
	)
	requireEqual(
		t,
		0.92,
	...
	requireEqual(
		t,
		0.38,
		requireFloat64Pointer(t, request.AuthoritySignalScoreMin, "authority_signal_score_min"),
	)
	requireEqual(
		t,
		0.96,
		requireFloat64Pointer(t, request.AuthoritySignalScoreMax, "authority_signal_score_max"),
	)
	requireEqual(
		t,
		0.75,
