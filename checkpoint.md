...
- **Go migration current checkpoint (2026-02-26):** CP108 completed in `checkpoint-go-migration.md` with `project.create` MCP dispatch in Go compatibility mode across direct and `tools/call` paths (including owner UUID validation), full `go test ./...` pass, and CodeScene safeguard pass.
