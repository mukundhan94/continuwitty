...
- **Phase 37 in progress:** freshness maintenance baseline shipped (schema fields, repository refresh routine, and admin API trigger route); consolidation suggestion workflows remain.
