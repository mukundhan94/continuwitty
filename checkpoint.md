...
- **Go migration current checkpoint (2026-02-27):** CP174 completed in `checkpoint-go-migration.md` with runtime verification baseline (`make stack-smoke` for Go API container build/start plus health/version probes), full `go test ./...` pass, and CodeScene safeguard pass.
