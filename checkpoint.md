...
- **Go migration current checkpoint (2026-02-27):** CP158 completed in `checkpoint-go-migration.md` with MCP stream-route token read-scope parity extension for direct write-tool methods (`chat.send_message` dotted + underscore alias), full `go test ./...` pass, and CodeScene safeguard pass.
