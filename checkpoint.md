...
- **Go migration current checkpoint (2026-02-27):** CP172 completed in `checkpoint-go-migration.md` with developer-workflow cutover baseline (Makefile backend defaults switched to Go commands with legacy Python commands retained under `py-*` targets), full `go test ./...` pass, and CodeScene safeguard pass.
