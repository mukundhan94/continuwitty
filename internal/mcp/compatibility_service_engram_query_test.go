...
func buildEngramQueryParityExpectations(
	...
	params := map[string]any{
		...
		"contradiction_count_min":          float64(contradictionCountMin),
		"contradiction_count_max":          float64(contradictionCountMax),
		"contradiction_feedback_ratio_min": contradictionFeedbackRatioMin,
		...
		"useful_feedback_ratio_max":        usefulFeedbackRatioMax,
		...
		"authority_signal_score_min":       authoritySignalScoreMin,
		"authority_signal_score_max":       authoritySignalScoreMax,
	...
	expected := EngramQueryDispatchRequest{
		...
		Payload: models.EngramQueryRequest{
			...
			ContradictionRatioMin:    &contradictionFeedbackRatioMin,
