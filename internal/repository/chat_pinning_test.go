...
func TestPinDocumentToSessionReturnsNilWhenResourceNotVisible(t *testing.T) {
...
func TestUnpinDocumentFromSessionReturnsFalseWhenMissing(t *testing.T) {
	db := &fakeQueryer{queryRowResult: &fakeRow{err: pgx.ErrNoRows}}
...
func TestListPinnedEngramsReturnsRows(t *testing.T) {
...
func TestListPinnedDocumentsAppliesVisibilityFilter(t *testing.T) {
