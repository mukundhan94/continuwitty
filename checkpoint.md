...
- **Go migration current checkpoint (2026-02-27):** CP150 completed in `checkpoint-go-migration.md` with MCP top-level invalid-request parity test coverage for no-session `chat.save_as_engram` missing `conversation_markdown`, full `go test ./...` pass, and CodeScene safeguard pass.
