...
- **Go migration current checkpoint (2026-02-27):** CP144 completed in `checkpoint-go-migration.md` with MCP token project-scope parity hardening for `engram.rehydrate` via rehydration-bundle project resolution, migrated policy tests, full `go test ./...` pass, and CodeScene safeguard pass.
