...
from . import chat_repository_pinning as _pinning
...
pin_engram_to_session = partial(_pinning.pin_resource_to_session, "engram")
unpin_engram_from_session = partial(_pinning.unpin_resource_from_session, "engram")
list_pinned_engrams = _pinning.list_pinned_engrams
list_pinned_engram_summaries = _pinning.list_pinned_engram_summaries
pin_document_to_session = partial(_pinning.pin_resource_to_session, "document")
unpin_document_from_session = partial(_pinning.unpin_resource_from_session, "document")
list_pinned_documents = _pinning.list_pinned_documents
