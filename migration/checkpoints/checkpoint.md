...
- **Phase 37 in progress:** freshness maintenance baseline plus consolidation schema/repository/admin-API/MCP parity baseline shipped (refresh/list/action API + tests); consolidation MCP action parity and acceptance/benchmark coverage remain.
...
- [ ] Add MCP consolidation action parity and acceptance/benchmark coverage.
