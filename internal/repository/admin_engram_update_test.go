	...
	return &fakeQueryer{
		queryRowResults: []*fakeRow{
			...
			{values: adminEngramRowValues(adminEngramRowFixture{
				...
				Abstract:                fixture.ExpectedAbstract,
				DetailedSummaryMarkdown: fixture.ExpectedDetailed,
				Tags:                    fixture.ExpectedTags,
		...
		queryRowsResults: []*fakeRows{
			{values: [][]any{adminEngramSourceRowValues(adminEngramSourceRowFixture{
				SourceID:   fixture.OldSourceID,
				CapturedAt: fixture.CapturedAt,
				URL:        "https://example.com/old",
			})}},
			{values: [][]any{{fixture.OldSourceID}}},
			{values: [][]any{adminEngramSourceRowValues(adminEngramSourceRowFixture{
				SourceID:   fixture.NewSourceID,
				CapturedAt: fixture.CapturedAt,
				URL:        "https://example.com/new",
			})}},
		},
