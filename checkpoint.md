...
- **Go migration current checkpoint (2026-02-26):** CP105 completed in `checkpoint-go-migration.md` with MCP direct-method compatibility baseline in Go (dotted/underscore tool method handling with token scope/allowlist policy parity), full `go test ./...` pass, and CodeScene safeguard pass.
