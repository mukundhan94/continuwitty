...
- **Go migration current checkpoint (2026-02-27):** CP139 completed in `checkpoint-go-migration.md` with MCP stream transport multi-frame parity tests for `chat.send_message` event+terminal sequences across JSON and SSE response modes, full `go test ./...` pass, and CodeScene safeguard pass.
