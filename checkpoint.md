...
- **Go migration current checkpoint (2026-02-27):** CP178 completed in `checkpoint-go-migration.md` with migration-checklist reconciliation in `migrate.md` (completed phases reflected through CP177 and pending operational rollout tasks left explicitly open), full `go test ./...` pass, and CodeScene safeguard pass.
