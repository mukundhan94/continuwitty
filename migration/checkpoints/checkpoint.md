...
- **Phase 40 in progress:** autonomous memory suggestions now include schema/model/repository foundations plus admin REST + MCP list/action parity (`engram.curation_list`, `engram.curation_action`) with regression coverage; suggestion-generation hooks and quality/latency benchmarks remain.
