...
- **UI polish follow-up completed (2026-03-04):** marketing/workspace UX refresh refined tokenized gradients/radii, flow-loop animation timing, favicon delivery, and light-theme palette contrast to reduce excessive brightness while keeping the established visual language.
