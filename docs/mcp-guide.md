...
`engram.query` also supports optional `dense_score_min`, `dense_score_max`, `composite_rank_score_min`, and `composite_rank_score_max` (all bounded `0..1`) for post-rerank score banding.
